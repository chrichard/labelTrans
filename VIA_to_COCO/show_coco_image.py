...
img_path = '/tao/maskrcnn/data/raw-data/validating_data/'
annFile = 'coco_anno.json'


img_path = '/AI/DLDataSet/cityscape/cityscape_labelme/train2017/'
annFile = '/AI/DLDataSet/cityscape/cityscape_labelme/annotations/instances_train2017.json'
